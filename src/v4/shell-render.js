...
export const NAV = [
    ...
    items: [
      {
        ...
        children: [
          { key: 'dashboard',   href: 'index.html',  text: 'Overview' },
          { key: 'dashboard-2', href: 'index2.html', text: 'Stock trends' },
          { key: 'dashboard-3', href: 'index3.html', text: 'Demand' },
          { key: 'dashboard-4', href: 'index4.html', text: 'Expiry watch' }
        ]
      },
      {
        text: 'Medicine forms', icon: 'forms', badge: { text: 'Hot', cls: 'badge-red' },
        children: [
          { key: 'forms',            href: 'form.html',            text: 'Medicine details' },
          { key: 'form-advanced',    href: 'form_advanced.html',   text: 'Batch upload' },
          { key: 'form-buttons',     href: 'form_buttons.html',    text: 'Restock form' },
          { key: 'form-upload',      href: 'form_upload.html',     text: 'Supplier info' },
          { key: 'form-validation',  href: 'form_validation.html', text: 'Approval flow' },
          { key: 'form-wizards',     href: 'form_wizards.html',    text: 'Medicine setup' }
        ]
      },
      {
        text: 'Inventory', icon: 'tables',
        children: [
          { key: 'tables',         href: 'tables.html',         text: 'Inventory list' },
          { key: 'tables-dynamic', href: 'tables_dynamic.html', text: 'Supplier records' }
        ]
      },
      {
        text: 'Reports', icon: 'charts', badge: { text: 'New', cls: 'badge-teal' },
        children: [
          { key: 'charts',       href: 'chartjs.html',     text: 'Demand charts' },
          { key: 'echarts',      href: 'echarts.html',     text: 'Inventory charts' },
          { key: 'other-charts', href: 'other_charts.html', text: 'Expiry charts' }
        ]
      },
      { key: 'calendar', href: 'calendar.html', text: 'Schedule', icon: 'calendar' },
      { key: 'map',      href: 'map.html',      text: 'Distribution',      icon: 'map' }
    ]
  },
  {
    label: 'Apps',
    items: [
      { key: 'chat',          href: 'chat.html',          text: 'Team chat',          icon: 'chat', badge: { text: '3', cls: 'badge-teal' } },
      { key: 'inbox',         href: 'inbox.html',         text: 'Messages',         icon: 'mail' },
      { key: 'kanban',        href: 'kanban.html',        text: 'Workflow',        icon: 'kanban' },
      { key: 'files',         href: 'file_manager.html',  text: 'Documents',         icon: 'files' },
      { key: 'notifications', href: 'notifications.html', text: 'Alerts', icon: 'bell' }
    ]
  },
  {
    label: 'E-commerce',
  ...
  },
  {
    label: 'Admin',
    items: [
      { key: 'users',           href: 'contacts.html',         text: 'Pharmacies',        icon: 'users' },
      { key: 'user_management', href: 'user_management.html',  text: 'Staff roles', icon: 'profile' },
      { key: 'profile',         href: 'profile.html',          text: 'Company profile',    icon: 'profile' },
      { key: 'settings',        href: 'settings.html',         text: 'Settings',        icon: 'settings' },
      { key: 'faq',             href: 'faq.html',              text: 'Support',     icon: 'help' }
    ]
  },
  {
    label: 'Layouts',
  ...
  return `
    <aside class="sidebar" aria-label="Primary navigation">
      <div class="sidebar-brand">
        ...
        <div class="brand-name">Living Healthy 24 <small>Medicine</small></div>
      </div>
  ...
  return `
    <header class="topbar">
      ...
      <div class="search-box">
        ...
        <input type="text" placeholder="Search medicines, suppliers or orders…" aria-label="Open command palette">
        <kbd>⌘K</kbd>
      </div>
...
export function renderFooter() {
  return `
    <footer class="footer">
      <span>Living Healthy 24 — medicine administration panel for inventory, stock, and orders.</span>
